...
public class DayPlanBuilderTests
{
    ...
    {
        // Closed at both ends: an off-by-one at either edge costs a day of service.
    ...
    public void Build_MoreVisitsThanTheVedtakGrants_ShowsTheExtraWithNoVedtakBehindIt()
    {
        ...
        // Came twice under a vedtak granting one visit; dropping the second would hide a visit that happened.
        Assert.Equal(2, plan.Items.Count);
    ...
    {
        // A family calendar entry has no service type, so the occurrence stays outstanding.
    ...
    {
        // Filtering it away would let an authorisation bug ship looking like a slow day.
